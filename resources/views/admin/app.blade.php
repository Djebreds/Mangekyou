            ...
            <figure class="m-0">
                ...
                <figcaption class="m-0">
                    <ul class="dropdown-menu dropdown-menu-end border-0 p-3 shadow">
                        ...
                        <li><a class="dropdown-item hstack gap-2" href="#"><i class='i-profile-user'></i>Profile</a>
                        </li>
                        <li><a class="dropdown-item hstack gap-2" href="#"><i class='i-profile-setting'></i>Setting</a>
                        </li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item hstack gap-2" href="#"><i class='i-profile-info'></i>Help</a></li>
                        <li><a class="dropdown-item hstack gap-2" href="#"><i class='i-profile-logout'></i>Sign out</a>
                        </li>
                    </ul>
                </figcaption>
            </figure>
