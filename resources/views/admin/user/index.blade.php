                                ...
                                <table class="table table-striped table-hover align-right mb-0 bg-white">
                                    <thead class="bg-light ">
                                        <tr class="table-secondary">
                                            ...
                                            <th class="sort fw-bold" data-sort="role">Role</th>
                                    ...
                                    <tbody class="list">
                                        @for ($i = 0; $i < 50; $i++)
                                            <tr>
                                                ...
                                                <td class="role"><span class="badge badge-secondary">Admin</span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="role"><span class="badge badge-primary">Buyyer</span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="role"><span class="badge badge-warning">Seller</span>
                                                </td>
