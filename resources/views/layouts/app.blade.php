...
<head>
    ...
    <meta name="description" content="Tohoku is a website marketplace buyying and selling">
    ...
    <link href="{{ asset('css/users-authenticate-style.css') }}" rel="stylesheet">
...
{{--                        <!-- Authentication Links --> @guest @if (Route::has('login'))--}}
...
{{--        </div>--}}
{{--    </nav>--}}
>>>>>>> d9cae3b (modified verification email)
    ...
    <script src="{{ URL::asset('js/users-authenticate-script.js') }}"></script>
</body>
